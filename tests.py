...
class TestGeolocationEnrichment(unittest.TestCase):
    ...
    def test_csv_file_writing(self, mock_csv_writer, mock_open_file):
        ...
        with open("codigos_postais_filled.csv", 'w', newline='') as csvfile:
            ...
            writer.writeheader.return_value = None
    ...
    def test_database_integration(self, mock_execute, mock_connect):
        ...
        mock_engine = mock_connect.return_value
        mock_engine.execute.return_value = None  # Simulate success

        # SQL command
        mock_engine.execute(f"""
